...
public class SphericalFunctionEngine {
     ...
     * @return					An array containing the coordinates of the new lastLocation, [0] = longitude, [1] = latitude, expressed in decimal degrees.
     */
     ...
     * @param distance			Distance from current lastLocation to new position, expressed in meters.
     * @param bearing			Compass bearing to new position, expressed in degrees.
